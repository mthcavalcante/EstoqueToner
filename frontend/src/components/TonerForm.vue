<template>
  <div class="max-w-2xl mx-auto bg-white shadow-md rounded my-6 p-6">
    ...
    <el-form @submit.prevent="saveToner" label-width="150px">
      <el-form-item 
        label="Nome do Toner" 
        :rules="[{ required: true, message: 'Por favor, insira o nome do toner', trigger: 'blur' }]">
        <el-input v-model="toner.name" placeholder="Nome do Toner"></el-input>
      </el-form-item>

      <el-form-item 
        label="Marca/Modelo Compatível" 
        :rules="[{ required: true, message: 'Por favor, insira a marca/modelo compatível', trigger: 'blur' }]">
        <el-input v-model="toner.compatible" placeholder="Marca/Modelo Compatível"></el-input>
      </el-form-item>

      <el-form-item 
        label="Código" 
        :rules="[{ required: true, message: 'Por favor, insira o código', trigger: 'blur' }]">
        <el-input v-model="toner.code" placeholder="Código"></el-input>
      </el-form-item>

      <el-form-item 
        label="Nível Mínimo de Estoque" 
        :rules="[{ required: true, message: 'Por favor, insira o nível mínimo', trigger: 'blur' }]">
        <el-input-number v-model="toner.min_level" :min="0" label="Nível Mínimo"></el-input-number>
      </el-form-item>

      <el-form-item 
        label="Estoque Atual" 
        :rules="[{ required: true, message: 'Por favor, insira o estoque atual', trigger: 'blur' }]">
